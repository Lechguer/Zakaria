...
void setup() {
  ...
  strs[0][0] = "Hey there!";
  strs[0][1] = "My name is Lechguer Zakaria.";

  strs[1][0] = "I'm a DATA & SOFTWARE ENGINEERING student ";
  strs[1][1] = "at Institut National de Statistique et d'Economie Appliquée (INSEA).";

  strs[2][0] = "I've been teaching myself how to code !";
...
### 🛠 &nbsp;Tech Stack
  ...
  ![C/C++](https://img.shields.io/badge/-C/C++-333333?style=flat&logo=c&logo=C/C++)
